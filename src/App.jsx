...
function App() {
    ...
    return (
        <div className="  bg-white dark:bg-[#181824] min-h-screen  h-full text-gray-100 flex items-center justify-center  px-5">
            <div className="w-screen bg-hero-mobile-light  dark:bg-hero-mobile-dark absolute top-0 z-10 h-[200px] bg-cover bg-no-repeat lg:bg-hero-light dark:lg:bg-hero-dark lg:h-[300px] ">
                {""}
            </div>
